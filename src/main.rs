    ...
    'main: loop {
        ...
        for event in event_pump.poll_iter() {
            match event {
                ...
                Event::KeyDown {keycode: Some(Keycode::Backspace),..} => {cpu.bus.keys.key_down(Keys::Select)}
                Event::KeyDown {keycode: Some(Keycode::Right),..} => {cpu.bus.keys.key_down(Keys::Right)}
                Event::KeyDown {keycode: Some(Keycode::Left),..} => {cpu.bus.keys.key_down(Keys::Left)}
                Event::KeyDown {keycode: Some(Keycode::Up),..} => {cpu.bus.keys.key_down(Keys::Up);}
                Event::KeyDown {keycode: Some(Keycode::Down),..} => {cpu.bus.keys.key_down(Keys::Down);}
                Event::KeyUp {keycode: Some(Keycode::Z),..} => {cpu.bus.keys.key_up(Keys::A)}
                Event::KeyUp {keycode: Some(Keycode::X),..} => {cpu.bus.keys.key_up(Keys::B)}
                Event::KeyUp {keycode: Some(Keycode::Return),..} => {cpu.bus.keys.key_up(Keys::Start)}
                Event::KeyUp {keycode: Some(Keycode::Backspace),..} => {cpu.bus.keys.key_up(Keys::Select)}
                Event::KeyUp {keycode: Some(Keycode::Right),..} => {cpu.bus.keys.key_up(Keys::Right)}
                Event::KeyUp {keycode: Some(Keycode::Left),..} => {cpu.bus.keys.key_up(Keys::Left)}
                Event::KeyUp {keycode: Some(Keycode::Up),..} => {cpu.bus.keys.key_up(Keys::Up)}
                Event::KeyUp {keycode: Some(Keycode::Down),..} => {cpu.bus.keys.key_up(Keys::Down)}
                _ => {}
            }
        }
